...
s_1s = Button((0,255,0),40,250,30,30, '1')
s_2s = Button((0,255,0),40,200,30,30, '2')
s_3s = Button((0,255,0),40,150,30,30, '3')
s_4s = Button((0,255,0),100,250,30,30, '4')
s_5s = Button((0,255,0),100,200,30,30, '5')
s_6s = Button((0,255,0),100,150,30,30, '6')
s_7s = Button((0,255,0),150,250,30,30, '7')
s_8s = Button((0,255,0),150,200,30,30, '8')
s_9s = Button((0,255,0),150,150,30,30, '9')
s_0s = Button((0,255,0),200,250,30,30, '0')

numbers = [s_1s,s_2s,s_3s,s_4s,s_5s,s_6s,s_7s,s_8s,s_9s,s_0s]

# the symbols!
d_1s = Button((0,255,0),260,250,30,30, '+')
d_2s = Button((0,255,0),260,200,30,30, '-')
d_3s = Button((0,255,0),260,150,30,30, 'x')
d_4s = Button((0,255,0),200,200,30,30, '÷')
d_5s = Button((0,255,0),320,250,30,30, '=')
d_6s = Button((0,255,0),320,200,30,30, '(')
d_7s = Button((0,255,0),320,150,30,30, ')')

symbols = [d_1s,d_2s,d_3s,d_4s,d_5s, d_6s, d_7s]

clearButton = Button((0,255,0),200,150,30,30, 'C')

allButtons = numbers + symbols + [clearButton]

# input tap
inputtap = Button((253,100,32),10,20,380,50,"")
